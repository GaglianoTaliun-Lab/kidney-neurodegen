...
data <- data.frame(
  Disease = c("AD_sexcombined", "AD_sexcombined", "AD_sexcombined", "AD_sexcombined", "AD_sexcombined", "AD_sexcombined",
              "NP_AD_sexcombined", "NP_AD_sexcombined", "NP_AD_sexcombined", "NP_AD_sexcombined", "NP_AD_sexcombined", "NP_AD_sexcombined", 
              ...
              "PD_sexcombined_meta", "PD_sexcombined_meta", "PD_sexcombined_meta", "PD_sexcombined_meta", "PD_sexcombined_meta", "PD_sexcombined_meta",
              "NP_PD_sexcombined_meta", "NP_PD_sexcombined_meta", "NP_PD_sexcombined_meta", "NP_PD_sexcombined_meta", "NP_PD_sexcombined_meta", "NP_PD_sexcombined_meta"),
  ...
  Rg = c(0.1702, 0.0401, -0.0651, -0.1156, -0.0245, 0.0222,
         -0.1668, -0.0293, 0.022, -0.0408, 0.1092, 0.075,
         -0.1218, -0.0873, -0.1124, -0.0915, -0.1238, 0.0236,
         -0.1160, -0.1027, -0.0871, -0.1062, -0.0726, 0.0262,
         -0.1542, -0.1149, -0.1561, -0.0789, -0.1672, 0.0627,
         -0.1728, -0.1033, -0.1369, -0.0769, -0.1513, 0.0742),
  P_value = c(0.1444, 0.7217, 0.2199, 0.0763, 0.6343, 0.6867,
              0.1057, 0.8025, 0.7123, 0.5358, 0.0678, 0.109,
              0.0991, 0.2253, 0.0014, 0.0208, 0.0009, 0.4872,
              0.1501, 0.1376, 0.0115, 0.0066, 0.0545, 0.419,
              0.0219, 0.1483, 0.00000089915, 0.0515, 0.00000053694, 0.0735,
              0.011, 0.2532, 0.000086083, 0.0827, 0.000010169, 0.0464))
...
ordered_diseases <- c("AD_sexcombined", "NP_AD_sexcombined", "PD_sexcombined", "NP_PD_sexcombined", "PD_sexcombined_meta", "NP_PD_sexcombined_meta")
...
pheatmap(heatmap_data, 
         ...
         labels_col = c("Proxy", "No Proxy", "Proxy", "No Proxy", "Proxy", "No Proxy"),
         angle_col = 0, 
         gaps_col = c(2,4),
         main = " ",
         fontsize_number = 10)
...
# Fig sup 1. Heatmap of AD and PD with proxies
...
# Reorder the traits and diseases
ordered_traits <- c("eGFR", "Hematuria", "Creatinine", "Microalbumin", "Potassium", "Sodium")
ordered_diseases <- c("AD_sexcombined", "AD_male", "AD_female", "PD_sexcombined", "PD_sexcombined_meta", "PD_male", "PD_female")
...
pheatmap(heatmap_data, 
         ...
         number_color = "black",
         gaps_col = c(3),
         labels_col = c("Sex-\ncombined", "Male", "Female", "Sex-\ncombined", "Sex-\ncombined\nmeta-analyzed", "Male", "Female"),  #Change the labels for different data used
         main = " ",
         angle_col = 0,
         fontsize_number = 10)


### Fig 3. Heatmap for PD with and No proxy
...
data <- data.frame(
  ...
  Traits = c(rep(c("Creatinine", "eGFR", "Hematuria", "Microalbumin", "Potassium", "Sodium"), 8)),
  Rg = c(-0.1124, 0.0236, -0.1218, -0.0873, -0.0915, -0.1238,  # PD_sexcombined
         ...
         -0.1561, 0.0627, -0.1543, -0.1149, -0.0789, -0.1672,  # PD_sexcombined_meta_analyzed
         -0.1369, 0.0742, -0.1728, -0.1033, -0.0769, -0.1513,   # NP_PD_sexcombined_meta_analyzed
  ...
  P_value = c(0.0014, 0.4872, 0.0991, 0.2253, 0.0208, 0.0009,  # PD_sexcombined
              ...
              0.00000089915, 0.0735, 0.0219, 0.1483, 0.0515, 0.00000053694, # PD_sexcombined_meta_analyzed 
              0.000086083, 0.0464, 0.011, 0.2532, 0.0827, 0.000010169,   # NP_PD_sexcombined_meta_analyzed 
